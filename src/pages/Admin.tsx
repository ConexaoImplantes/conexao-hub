  ...
  <div className="space-y-1.5">
    ...
    <div className="flex items-center gap-2">
      ...
      <input
        ...
        value={value}
        onChange={(e) => onChange(e.target.value)}
        className="flex-1 p-2 rounded-lg bg-gray-50 dark:bg-black/20 text-sm font-mono uppercase focus:ring-2 outline-none"
...
const ThemeEditorSection = ({ title, children }: { title: string; children?: React.ReactNode }) => (
  <div className="space-y-3 mb-6">
    <h4 className="text-xs font-bold uppercase tracking-wider pb-2" style={{ color: "var(--color-text-muted)" }}>
      {title}
    </h4>
  ...
  >
    ...
    <div className="p-4 space-y-3">
      <div className="flex gap-2 mb-2">
        <div
          className="h-4 px-2 rounded-full text-[10px] flex items-center font-bold"
          style={{ color: scheme.success, backgroundColor: scheme.success + "20" }}
        >
          Ativo
        </div>
        <div
          className="h-4 px-2 rounded-full text-[10px] flex items-center font-bold"
          style={{ color: scheme.warning, backgroundColor: scheme.warning + "20" }}
        >
          Pendente
        </div>
      </div>
      <div className="p-3 rounded-lg shadow-sm" style={{ backgroundColor: scheme.surface }}>
        ...
        <div className="flex gap-2 mt-3 justify-end">
          <div className="w-4 h-4 rounded-full flex items-center justify-center" style={{ color: scheme.error }}>
            <X size={12} />
          </div>
          <div className="w-4 h-4 rounded-full flex items-center justify-center" style={{ color: scheme.success }}>
            <Check size={12} />
          </div>
        </div>
      </div>
...
export const Admin: React.FC = () => {
  ...
  const handleSaveMaterial = async (materialData: any) => {
    try {
      if (materialData.id) await mockDb.updateMaterial(materialData);
  ...
  const handleView = (material: Material) => {
    ...
    if (availableLang) setViewingMaterial({ mat: material, lang: availableLang });
    else alert(t("no.materials"));
  };
              ...
              {settingsTab === "themes" && (
                ...
                >
                  <div className="grid lg:grid-cols-2 gap-8">
                    <div className="space-y-6">
                      <div
                        className="flex items-center gap-2 font-semibold pb-2 border-b"
                      ...
                      <ThemeEditorSection title="Estrutura Base">
                        <ColorInput
                          ...
                          onChange={(v) =>
                            setLocalConfig({ ...localConfig, themeLight: { ...localConfig.themeLight, background: v } })
                          }
                          hint="Fundo geral"
                        />
                        <ColorInput
                          ...
                          onChange={(v) =>
                            setLocalConfig({ ...localConfig, themeLight: { ...localConfig.themeLight, surface: v } })
                          }
                          hint="Cards e headers"
                        />
                        <ColorInput
                          label="Borders"
                          value={localConfig.themeLight.border}
                          onChange={(v) =>
                            setLocalConfig({ ...localConfig, themeLight: { ...localConfig.themeLight, border: v } })
                          }
                      ...
                      <ThemeEditorSection title="Tipografia">
                        <ColorInput
                          ...
                          onChange={(v) =>
                            setLocalConfig({ ...localConfig, themeLight: { ...localConfig.themeLight, textMain: v } })
                          }
                          hint="Títulos"
                        />
                        <ColorInput
                          ...
                          onChange={(v) =>
                            setLocalConfig({ ...localConfig, themeLight: { ...localConfig.themeLight, textMuted: v } })
                          }
                          hint="Legendas"
                        />
                      </ThemeEditorSection>
                      <ThemeEditorSection title="Marca">
                        <ColorInput
                          ...
                          onChange={(v) =>
                            setLocalConfig({ ...localConfig, themeLight: { ...localConfig.themeLight, accent: v } })
                          }
                      ...
                      <ThemeEditorSection title="Status">
                        <ColorInput
                          ...
                          onChange={(v) =>
                            setLocalConfig({ ...localConfig, themeLight: { ...localConfig.themeLight, success: v } })
                          }
                          hint="Ativo"
                        />
                        <ColorInput
                          ...
                          onChange={(v) =>
                            setLocalConfig({ ...localConfig, themeLight: { ...localConfig.themeLight, warning: v } })
                          }
                          hint="Pendente"
                        />
                        <ColorInput
                          ...
                          onChange={(v) =>
                            setLocalConfig({ ...localConfig, themeLight: { ...localConfig.themeLight, error: v } })
                          }
                          hint="Perigo"
                        />
                      </ThemeEditorSection>
                    ...
                    <div className="space-y-6">
                      ...
                      <ThemeEditorSection title="Estrutura Base">
                        <ColorInput
                          ...
                          onChange={(v) =>
                            setLocalConfig({ ...localConfig, themeDark: { ...localConfig.themeDark, background: v } })
                          }
                          hint="Fundo geral"
                        />
                        <ColorInput
                          ...
                          onChange={(v) =>
                            setLocalConfig({ ...localConfig, themeDark: { ...localConfig.themeDark, surface: v } })
                          }
                          hint="Cards e headers"
                        />
                        <ColorInput
                          ...
                          onChange={(v) =>
                            setLocalConfig({ ...localConfig, themeDark: { ...localConfig.themeDark, border: v } })
                          }
                          hint="Linhas divisórias"
                        />
                      </ThemeEditorSection>
                      <ThemeEditorSection title="Tipografia">
                        <ColorInput
                          ...
                          onChange={(v) =>
                            setLocalConfig({ ...localConfig, themeDark: { ...localConfig.themeDark, textMain: v } })
                          }
                          hint="Títulos"
                        />
                        <ColorInput
                          ...
                          onChange={(v) =>
                            setLocalConfig({ ...localConfig, themeDark: { ...localConfig.themeDark, textMuted: v } })
                          }
                          hint="Legendas"
                        />
                      </ThemeEditorSection>
                      <ThemeEditorSection title="Marca">
                        <ColorInput
                          ...
                          onChange={(v) =>
                            setLocalConfig({ ...localConfig, themeDark: { ...localConfig.themeDark, accent: v } })
                          }
                          hint="Botões e destaques"
                        />
                      </ThemeEditorSection>
                      <ThemeEditorSection title="Status">
                        <ColorInput
                          ...
                          onChange={(v) =>
                            setLocalConfig({ ...localConfig, themeDark: { ...localConfig.themeDark, success: v } })
                          }
                          hint="Ativo"
                        />
                        <ColorInput
                          ...
                          onChange={(v) =>
                            setLocalConfig({ ...localConfig, themeDark: { ...localConfig.themeDark, warning: v } })
                          }
                          hint="Pendente"
                        />
                        <ColorInput
                          ...
                          onChange={(v) =>
                            setLocalConfig({ ...localConfig, themeDark: { ...localConfig.themeDark, error: v } })
                          }
                          hint="Perigo"
                        />
                      </ThemeEditorSection>
