                    ...
                    <tr key={user.id} className="transition-colors" style={{ color: 'var(--color-text-main)' }}>
                      ...
                      <td className="p-4 text-right">
                        <div className="flex justify-end gap-1 items-center">
                          <button onClick={() => setUserComm(user)} className="p-2 rounded-lg border border-transparent" title={t('comm.title')} style={{ color: 'var(--color-accent)' }}><MessageCircle size={18} /></button>
                          {user.status === 'pending' && (
                            <>
