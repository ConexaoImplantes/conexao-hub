...
export const CollectionFormModal: React.FC<CollectionFormModalProps> = ({ initialData, onClose, onSave }) => {
  ...
  return createPortal(
    <div className="fixed inset-0 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in" style={{ zIndex: 9999 }}>
      <div className="rounded-2xl w-full max-w-3xl shadow-2xl flex flex-col max-h-[90vh] overflow-hidden animate-slide-up" style={{ backgroundColor: 'var(--color-surface)' }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="sm:w-32">
                ...
                <div
                  ...
                  className={`cursor-pointer p-3 rounded-xl flex items-center justify-between transition-colors h-[52px] ${active ? 'bg-green-500/10 text-green-600 dark:text-green-400' : ''}`}
              ...
              <div className="sm:w-28">
                <label className="text-[11px] font-bold uppercase mb-2 flex items-center gap-1 tracking-wider" style={{ color: 'var(--color-text-muted)' }}>
                  <Star size={12} className="text-yellow-400" /> XP Total
                </label>
