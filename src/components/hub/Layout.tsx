        ...
        <div className="container mx-auto">
            ...
            <div className="flex items-center space-x-4 group cursor-default">
                <div className="relative">
                    ...
                    <div className="relative w-10 h-10 bg-gradient-to-br from-blue-900 to-amber-600 rounded-xl flex items-center justify-center text-white font-bold shadow-lg transition-transform duration-500 group-hover:rotate-6 group-hover:scale-110">
            ...
            <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-3 pl-2">
                    <div className="flex items-center gap-3 rounded-full p-1 pr-4 transition-all duration-300 cursor-default group" style={{ backgroundColor: 'color-mix(in srgb, var(--color-bg) 50%, transparent)', border: '1px solid color-mix(in srgb, var(--color-border) 50%, transparent)' }}>
                        <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-blue-900 to-amber-500 flex items-center justify-center text-white text-sm font-bold shadow-md ring-2 ring-white/20 transition-all">
                            {user?.name.charAt(0)}
                        </div>
